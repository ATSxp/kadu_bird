...
namespace Menu {
  ...
  void initMenu() {
    ...
    Global::se_ballon(&se_mem[bg[0]->sbb][0], 0, 0, 10, 4, SE_ID(403) | SE_PALBANK(2));
  }
  ...
  void updateMenu() {
    ...
    if (evy > 0x040) btns->onInput(false);
    else btns->onInput(true);
